...
public class LoginParameterStepDefs {

	WebDriver driver;

	@Given("User successfully opened {string} website")
	public void user_successfully_opened_website(String url) {
	...
	@Given("Title of the page should_display")
	...
	public void user_search_for_the_product_as(String productName) throws Exception {
		driver.findElement(By.xpath("//input[@id='twotabsearchtextbox']")).sendKeys(productName);
		Thread.sleep(5000);
	}
	

	@When("Click on the Search_button")
